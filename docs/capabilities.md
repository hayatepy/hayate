...
- **Hayate — First-party:** hayate-openapi 0.5 provides explicit source markers, response contracts, providers, and Scalar. ([evidence 1](https://github.com/hayatepy/hayate/blob/main/benchmarks/ecosystem/runner.py), [evidence 2](https://github.com/hayatepy/hayate/blob/main/docs/ecosystem-compatibility.md))
